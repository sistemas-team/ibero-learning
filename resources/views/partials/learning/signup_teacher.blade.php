            ...
            <div class="col-lg-6">
                <div class="signup-warp">
                    <div class="section-title text-white text-left">
                        ...
                        <p>{{ __('Rellena el siguiente formulario y daremos de alta tu perfil de instructor en la plataforma para que puedas empezar a crear tus cursos') }}
                        </p>
                    </div>
                    <!-- signup teacher form -->
                    <form autocomplete="off" id="teacher-form" class="signup-form" action="{{ route('register') }}"
                        method="POST">
                        @csrf
